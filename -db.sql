...
('menu', 'Snack Box', 'img/snack_box.png', 'chicken', 4.59),
('menu', 'Twister', 'img/twister.png', 'wrap', 6.59),
('snack', 'Chips', 'img/chips.png', 'potato', 2.59),
...
('extra', 'Maionese', 'img/maionese.png', 'mayonnaise', 0.59),
